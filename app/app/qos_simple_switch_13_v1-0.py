...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        queues = []
        queues.append({REST_QUEUE_MAX_RATE:"1000000"})
        queues.append({REST_QUEUE_MIN_RATE:"200000"})
        ...
        vlan_id=1
        qos.set_queue(rest,vlan_id)
        self.logger.info(qos.get_queue(rest, vlan_id))
