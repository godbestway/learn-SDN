...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        #set queues
        queues = []
        queues.append({REST_QUEUE_MAX_RATE:"500000"})
        queues.append({REST_QUEUE_MIN_RATE:"800000"})
        self.logger.info("packetinhahahahahhahaha")
        rest = {REST_PORT_NAME:"s1-eth1" , REST_QUEUE_TYPE:"linux-htb" , REST_QUEUE_MAX_RATE:"1000000" , REST_QUEUES:queues}
        self.logger.info(qos.set_queue(rest , 0))
        
        #set qos rules
        rest_match = {REST_DST_IP:"10.0.0.1" , REST_NW_PROTO:"UDP" , REST_TP_DST:"5002"}
        rest_action = {REST_ACTION_QUEUE:"1"}
        rest2 = {REST_MATCH:rest_match , REST_ACTION:rest_action}
        self.logger.info(qos.set_qos(rest2 , 0 , None))
