...
#        print "originalllll" , original_port_rate 
	if first_time == False:
...
#	original_port_rate = []
	...
	'''
#        keys = []
#        qos_legnth = len(selfqos_list)
#        for i in range(qos_length):
#            k0 = i.keys()
#            keys.append(k0[0])
...
#            k = keys[i]
#            queues.append(original_port_rate[i][k])
...
#        print "22222222" , queues , "------" , selfqos_list
	...
	for i in range(len(queues)):
		...
		original_port_rate.append(old_dict)
                print "ooooooooo" , original_port_rate
        '''
...
#			print "buzai",i
	...
	#reset related queue_number
        ...
        print "current_queues" , current_queues , "original2" , original_port_rate
...
#        print "advanced_queues" , advanced_queues
	print "--------------------\n"
