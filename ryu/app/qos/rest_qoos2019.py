...
#        selfovs_bridge = None
	...
	regular_queues = self.develop_regular_queues(port, priority, come_min_rate, come_max_rate)
...
#        mm = self.ofctl.get_flow_stats(self.dp , outside_waiters)
	return REST_COMMAND_RESULT, [last_port_stats]
     ...
     #left_max_rate = 0
    def develop_regular_queues(self, priority, port, come_min_rate, come_max_rate):
    	global selfqos_list
        global selfqueue_list
        #global selfqueues_single
        #global timer 
