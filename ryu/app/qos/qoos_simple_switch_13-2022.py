...
from rest_qoos import QoS
#from rest_qoos60 import QoS
#from rest_qoos80 import QoS
#from shiyi_test_qos import QoS
from rest_qoos import QoS
...
from rest_qoos import REST_PRIORITY
from rest_qoos import REST_QUEUE_PRIORITY
from rest_qoos import BASE_URL
from rest_qoos import REQUIREMENTS
from rest_qoos import original_port_rate
...
#        self.logger.info(ev.msg.datapath)
        
        datapath = ev.msg.datapath
        #self.logger.info(dir(datapath))
        p = datapath.ports
#        self.logger.info("556564654654")
        #self.logger.info(p)        
        ...
        queues.append({REST_QUEUE_MIN_RATE:"600000"})
        rest = {REST_PORT_NAME:"" , REST_QUEUE_TYPE:"linux-htb" , REST_QUEUE_MAX_RATE:"1000000" , REST_QUEUES:queues}
        #set qos rules
        ...
        rest_setQos =  []
	rest_setQos.append(rest1)
        #rest_setQos.append(rest2)
        self.logger.info(qos.set_queue_forAll(rest , rest_setQos , 0, {}))
        self.logger.info(qos.get_queue({} , 0))  
#        qos.set_queue_forAll(rest , rest_setQos , 0, {})
#        qos.get_queue({} , 0)
#        self.logger.info("ooooookkkkkk")       
    ...
    def add_Switch_Port(self , qos , port_name , ip_addr):
        ...
        self.logger.info("getqueueuuuuuuuuuu")
        self.logger.info(sqos.get_queue({} , 0))
        self.logger.info("gggggggggggggggggg")

        #set qos rules
        rest_match = {REST_DST_IP:ip_addr , REST_NW_PROTO:"UDP" , REST_TP_DST:"5002"}
        rest_action = {REST_ACTION_QUEUE:"1"}
        rest2 = {REST_MATCH:rest_match , REST_ACTION:rest_action}
        self.logger.info(sqos.set_qos(rest2 , 0 , None))

        rest_match = {REST_DST_IP:ip_addr , REST_NW_PROTO:"UDP" , REST_TP_DST:"5003"}
        rest_action = {REST_ACTION_QUEUE:"2" }
        rest3 = {REST_MATCH:rest_match , REST_ACTION:rest_action}
        self.logger.info(sqos.set_qos(rest3 , 0 , None))
    ...
    def _packet_in_handler(self, ev):
        ...
        self.logger.info("curljingguoleszheli hahahahahha")
        ...
        self.logger.info("5555555555555555555555555555")
    ...
    def set_qos(self, req, switchid, **_kwargs):
        ...
        self.logger.info("123321123321123321123321")
